    ...
    <div style={{ padding: S.containerPad, maxWidth: 800, margin: "0 auto" }}>
      ...
      <div style={{ background: "#1a1a2e", border: "1px solid #2d3748", borderRadius: 12, padding: 14, marginBottom: 16 }}>
        ...
        <div style={{ marginBottom: 10 }}>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <input type="password" value={cfg.apiKey || ""} onChange={function(e) { update("apiKey", e.target.value); }} placeholder="Plak je API key hier..." style={{ flex: 1, padding: "8px 12px", borderRadius: 8, border: "1px solid " + (cfg.apiKey ? "#22c55e44" : "#ef444444"), background: "#1e1e30", color: "#e5e5e5", fontSize: 13, outline: "none", boxSizing: "border-box" }} />
